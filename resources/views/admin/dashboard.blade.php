                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="Daily" role="tabpanel">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <svg class="mr-2" width="27" height="14" viewBox="0 0 27 14"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body loadmore-content height620 dlab-scroll  pb-0"
                                    ...
                                    <div class="border-bottom pb-4 mb-4">
                                        <a href="javascript:void(0)" class="btn btn-sm btn-success rounded-xl mb-2">Graphic
                                            Deisgner</a>
                                        ...
                                        <div class="row justify-content-between">
                                            <ul class="users col-6">
                                                <li><img src="{{ asset('public/backend/images/users/1.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/2.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/3.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/4.jpg') }}" alt="">
                                                </li>
                                            </ul>
                                    ...
                                    <div class="border-bottom pb-4 mb-4">
                                        ...
                                        <p class="font-w600"><a href="post-details.html" class="text-black">Build
                                                Database Design for Fasto Admin v2</a>
                                        </p>
                                        <div class="row justify-content-between">
                                            <ul class="users col-6">
                                                <li><img src="{{ asset('public/backend/images/users/5.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/6.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/7.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/8.jpg') }}" alt="">
                                                </li>
                                            </ul>
                                            <div class="col-6 pl-0">
                                                <h6 class="fs-14">Progress
                                    ...
                                    <div class="border-bottom pb-4 mb-4">
                                        ...
                                        <p class="font-w600"><a href="post-details.html" class="text-black">Make
                                                Promotional Ads for Instagram
                                                Fasto’s</a></p>
                                        <div class="row justify-content-between">
                                            <ul class="users col-6">
                                                <li><img src="{{ asset('public/backend/images/users/9.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/10.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/11.jpg') }}" alt="">
                                                </li>
                                                <li><img src="{{ asset('public/backend/images/users/12.jpg') }}" alt="">
                                                </li>
                                            </ul>
                                            <div class="col-6 pl-0">
                                                <h6 class="fs-14">Progress
