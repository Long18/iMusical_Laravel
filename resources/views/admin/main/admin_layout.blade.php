...
<head>
    ...
    <link href="{{ asset('public/backend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/backend/vendor/jqvmap/css/jqvmap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/backend/vendor/chartist/css/chartist.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/backend/vendor/owl-carousel/owl.carousel.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('public/backend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('public/backend/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ URL::to('/admin/all-brands') }}">All Brands</a></li>
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://www.facebook.com/William.2418/" target="_blank">Isekai Team</a>
                    2022</p>
            </div>
        </div>
    ...
    <script src="{{ asset('public/backend/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}" type="text/javascript"></script>
