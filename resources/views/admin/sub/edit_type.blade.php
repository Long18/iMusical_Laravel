                        ...
                        <div class="card-body">
                            ...
                            @foreach ($edit_type as $key => $edit_value)
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ URL::to('/update-type/'.$edit_value->type_id) }}" method="post">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" for="val-name-type">Name
                                                        type
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label"
                                                        for="val-confirm-password">Confirm
