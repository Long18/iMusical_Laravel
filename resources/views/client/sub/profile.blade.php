                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                    <div class="sc-card-profile text-center">
                        <div class="card-media">
                            <img id="profileimg" src="{{ asset('public/frontend//images/avatar/avata_profile.jpg') }}" alt="Image">
                        </div>
                ...
                <div class="col-xl-9 col-lg-8 col-md-12 col-12">
                    <div class="form-upload-profile">
                        ...
                        <div class="option-profile clearfix">
                            ...
                            <div class="image">
                                <img src="{{ asset('public/frontend//images/backgroup-secsion/option1_bg_profile.jpg') }}" alt="">
                            </div>
                            <div class="image style2">
                                <img src="{{ asset('public/frontend//images/backgroup-secsion/option2_bg_profile.jpg') }}" alt="">
                            </div>
                        </div>
