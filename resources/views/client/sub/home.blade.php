                                                                                                    ...
                                                                                                    <div class="slider-item">
                                                                                                        <div class="sc-author-box style-2">
                                                                                                            ...
                                                                                                            <div class="author-infor">
                                                                                                                <h5><a href="author02.html">' .
                                    $product->product_name .
                                    '</a></h5>
                                                                                                                <span class="price">' .
                                    $priceNPriceSale->price .
                                    '</span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div><!-- item-->
                                    ...
                                    foreach ($categories as $category) {
                                        echo '<a class="dropdown-item" href="category/">
                                                                                                                            <div class="sort-filter">
                                                                                                                                <span><img src="public/frontend/images/icon/rainbow.png" alt="" /> ' .
                                            $category->type_name .
                                            '</span>
                                                                                                                                <i class="fal fa-check"></i>
                                                                                                                            </div>
                    ...
                    foreach ($products as $product) {
                        ...
                        echo '<div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                                            <div class="sc-card-product">
                                                                ...
                                                                <div class="card-title">
                                                                    <h5 class="style2"><a href="item-details.html">' .
                            $product->product_name .
                            '</a></h5>
                                                                    <div class="tags">bsc</div>
                                                                </div>
