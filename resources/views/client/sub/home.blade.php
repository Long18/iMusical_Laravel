                    ...
                    <div class="themesflat-container ">
                        <div class="wrap-heading flat-slider flex">
                            <div class="content">
                                ...
                                <p class="sub-heading mg-t-29 mg-bt-44">Music is the mediator between the spiritual and the sensual life.
                                </p>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="swiper-container show-shadow carousel pad-t-17 auctions">
                    <div class="swiper-wrapper">
                        <?php
                        $products = Session::get('newProducts');
                                                        ...
                                                        <div class="card-media">
                                                            ...
                                                            <div class="button-place-bid">
                                                                <a href="#" data-toggle="modal" data-target="#popup_bid"
                                                                    class="sc-button style-place-bid style bag fl-button pri-3"><span> Add to Cart </span></a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="slider-item">
                                                <div class="sc-author-box style-2">
                                                    ...
                                                    <div class="author-infor">
                                                        ...
                                                        <span class="price">' . $priceNPriceSale->price . '</span>
                                                    </div>
                                                </div>
                                            </div><!-- item-->
                                        </div>';
        ...
        <div class="row">
                    ...
                    <div class="soft-left">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                $categories = Session::get('categories');
                                foreach ($categories as $category) {
                                    echo '<a class="dropdown-item" href="category/">
            ...
            if ($products) {
                foreach ($products as $product) {
                    $brand = $product->getBrand();
                    $priceNPriceSale = Product::formatPriceToVND($product->price);
                    echo '<div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="sc-card-product">
                                <div class="card-media">
