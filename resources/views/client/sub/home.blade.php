                ...
                <div class="slider-item">
                    <div class="themesflat-container ">
                        <div class="wrap-heading flat-slider flex">
                            ...
                            <div class="image">
                                <img class="img-bg" src="{{ asset('public/frontend/images/backgroup-secsion/img-bg-sliderhome2.png') }}" alt="Image">
                ...
                <div class="slider-item">
                    <div class="themesflat-container flex">
                        <div class="image three">
                            ...
                            <img class="img-bg" src="{{ asset('public/frontend/images/backgroup-secsion/img-bg-sliderhome3.png') }}" alt="Image">
                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="slider-item">
                                        <div class="sc-card-product">
                                            ...
                                            <form action="">
                                                @csrf
                                                <input type="hidden" name="cart_product_id" value="{{ $product->product_id }}" class="cart_product_id_{{ $product->product_id }}">
                                                <input type="hidden" name="cart_product_name" value="{{ $product->product_name }}" class="cart_product_name_{{ $product->product_id }}">
                                                ...
                                                <input type="hidden" name="cart_product_brand" value="{{ $brand->brand_name }}" class="cart_product_brand_{{ $product->product_id }}">
                                                ...
                                                <div class="card-media">
                                                    ...
                                                    <div class="button-place-bid">
                                                        <button href="#" data-id="{{ $product->product_id }}" name="add-to-cart" type="button" class="sc-button style-place-bid style bag fl-button pri-3 add-to-cart"><span>
                                                                Add to Cart </span></button>
                                                    </div>
                                                </div>
                                            </form>
                                            <div class="card-title">
                                                <h3><a href="{{ URL::to('/item-detail/' . $product->product_id) }}" method="post">{{$product->product_name}}</a></h3>
                                            </div>
                                            <div class="meta-info">
                                                <div class="author">
                                                    <div class="avatar">
                                ...
                                <div class="slider-item">
                                    <div class="sc-author-box style-2">
                                        <div class="author-avatar">
                                            <img src="public/frontend/images/avatar/avt-1.jpg" alt="" class="avatar">
                                            <div class="badge"></div>
                                        </div>
                                        ...
                                        <div class="sc-card-collection style-2 home2">
                                            ...
                                            <a href="author02.html">
                                                <div class="media-images-collection">
                                                    <div class="box-left">
                                                        <img src="public/frontend/images/box-item/collection-item-2.jpg" alt="">
                                                    </div>
                                                    <div class="box-right">
                                                        <div class="top-img">
                                                            <img src="public/frontend/images/box-item/collection-item-top-1.jpg" alt="">
                                                            <img src="public/frontend/images/box-item/collection-item-top-2.jpg" alt="">
                                                        </div>
                                                        <div class="bottom-img">
                                                            <img src="public/frontend/images/box-item/collection-item-bottom-4.jpg" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
        ...
        <div class="row">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#">
                                    <div class='sort-filter active'>
                                        <span><img src="{{ asset('public/frontend/images/icon/menu.png') }}" alt="" />
                                            All</span>
            ...
            ?>
                    <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        <div class="sc-card-product">
                            <div class="card-media">
                                <a href="item-details.html"><img src="public/frontend/images/box-item/card-item-3.jpg" alt="Image"></a>
                            </div>
                            <div class="card-title">
                            ...
                            <div class="card-bottom">
                                <a href="#" data-toggle="modal" data-target="#popup_bid" class="sc-button style bag fl-button pri-3"><span> Add to Cart </span></a>
