            ...
            <div class="col-xl-6 col-md-12">
                <div class="content-right">
                    <div class="sc-item-details">
                        ...
                        <a href="#" data-toggle="modal" data-target="#popup_bid" class="sc-button loadmore style bag fl-button pri-3"><span>Add to
                                cart</span></a>
                            ...
                            <div class="content-tab">
                                <div class="content-inner tab-content">
                                    <ul class="bid-history-list">
                                        ...
                                        ?>
                                                <li>
                                                    <h1>{{ $typeDetail->getType->type_name}}: </h1>
                                                    <span>{{$typeDetail->type_detail_value}}</span>
                                                </li>
                                        <?php
                                            }
                                        }
