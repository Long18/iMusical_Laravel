                                            ...
                                            <ul>
                                                <li class="menu-icon">
                                                    ...
                                                    <ul class="sub-menu menu-pages-img-show">
                                                        <li>
                                                            <a href="{{URL::to('/home')}}">Home Style 01</a>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="{{URL::to('/service-details')}}">Service Details</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/portfolio')}}">Portfolio</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/portfolio-2')}}">Portfolio - 02</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/portfolio-details')}}">Portfolio Details</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/team')}}">Team</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/team-details')}}">Team Details</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/faq')}}">FAQ</a>
                                    </li>
                                    <li>
                                        <a href="{{URL::to('/locations')}}">Google Map Locations</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{URL::to('/about')}}shop.html">Shop</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid.html">Shop Grid</a>
                                    </li>
